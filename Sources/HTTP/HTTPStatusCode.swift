...
extension HTTPStatusCode: ExpressibleByIntegerLiteral {
    public typealias IntegerLiteralType = HTTPStatusCode.RawValue
...
extension HTTPStatusCode: CaseIterable {
    public static let allCases: [HTTPStatusCode] = [
        ...
        .badRequest, .unauthorized, .paymentRequired, .forbidden, .notFound, .methodNotAllowed, .notAcceptable, .proxyAuthenticationRequired, .requestTimeout, .conflict, .gone, .lengthRequired, .preconditionFailed, .contentTooLarge, .uriTooLong, .unsupportedMediaType, .rangeNotSatisfiable, .expectationFailed, .teapot, .misdirectedRequest, .unprocessableContent, .upgradeRequired,
